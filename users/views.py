...
from .forms import CustomUserCreationForm, profileForm, videoForm, imageForm, projectForm
...
def userAccount(request):
    ...
    context = {'profiledata': form, 'videodata':videodata, 'imagedata':imagedata, 'projectdata':projectdata}
